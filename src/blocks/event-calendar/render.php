		...
		case 'custom':
			if ( ! empty( $custom_dates ) ) {
				...
				foreach ( $custom_dates as $custom_date ) {
					...
					$end = isset( $custom_date['end'] ) && $custom_date['end'] != null ? gmdate( 'Y-m-d H:i:s', strtotime( $custom_date['end'] . '  23:59:59' ) ) : gmdate( 'Y-m-d H:i:s', strtotime( $custom_date['start'] . '  23:59:59' ) );
